...
<footer class="px-20 py-16 flex flex-col items-center bg-[#0B0B0B] border-t border-white/10">
    <div class="flex flex-col items-center gap-4 mb-12">
        <a href="/" class="block">
            <img src="logo.svg" class="w-10" alt="Logo" />
        </a>
        <h2 class="text-lg text-center">Association for Computing Machinery at UM Flint</h2>
    ...
    <div class="w-full flex justify-between items-center border-t border-white/10 pt-8">
        <p class="text-sm text-white/50">&copy; Association for Computing Machinery @ University of Michigan - Flint. All rights reserved.</p>
        <div class="flex gap-6">
            <a href="https://github.com/ACM-at-UMFlint" target="_blank" class="hover:text-white/90 text-white/50 transition-colors">
                <Github />
            </a>
            <a href="https://instagram.com/acm.umflint" target="_blank" class="hover:text-white/90 text-white/50 transition-colors">
                <Instagram />
            </a>
            <a href="https://linkedin.com/company/acm-at-umflint" target="_blank" class="hover:text-white/90 text-white/50 transition-colors">
                <Linkedin />
            </a>
        </div>
    </div>
